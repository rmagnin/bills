...
export class ParticipationComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.participationService
      ...
      .subscribe((res: HttpResponse<IParticipation[]>) => this.paginateParticipations(res.body, res.headers));
  }
  ...
  protected paginateParticipations(data: IParticipation[], headers: HttpHeaders) {
