...
export class ChampionshipComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.championshipService
      ...
      .subscribe((res: HttpResponse<IChampionship[]>) => this.paginateChampionships(res.body, res.headers));
  }
  ...
  protected paginateChampionships(data: IChampionship[], headers: HttpHeaders) {
